...
class NewsletterAction {
    ...
    public static function unsuscribe($key){
        $key = urldecode($key);
        return NewsletterActionDao::emailOptOut($key);
    }
    ...
    public static function sendUnsuscriptionMail($email){
        ...
        if(NewsletterActionDao::isEmailOnDatabase($email)){
            
            
            $key = NewsletterActionDao::getKey($email);
    ...
    public static function addEmail($nom, $prenom, $email, $optin){
        return NewsletterActionDao::addEmail($nom, $prenom, $email, $optin);
    }
