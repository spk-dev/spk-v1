...
CREATE  TABLE IF NOT EXISTS `spibook-1.0`.`Lieu` (
  ...
  `lieu-dateEnregistrement` DATETIME NULL ,
  PRIMARY KEY (`lieu-id`) ,
...
CREATE  TABLE IF NOT EXISTS `spibook-1.0`.`Retraite` (
  ...
  `retraite-dateEnregistrement` DATETIME NULL ,
...
CREATE  TABLE IF NOT EXISTS `spibook-1.0`.`Pelerinage` (
  ...
  `Lieu_lieu-id` INT NOT NULL ,
  `pelerinage-dateEnregistrement` DATETIME NULL ,
...
-- -----------------------------------------------------
-- Table `spibook-1.0`.`Intervenant_Pelerinage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spibook-1.0`.`Intervenant_Pelerinage` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `spibook-1.0`.`Intervenant_Pelerinage` (
  `Intervenant_intervenant-id` INT NOT NULL ,
  `Pelerinage_pelerinage-id` INT NOT NULL ,
  PRIMARY KEY (`Intervenant_intervenant-id`, `Pelerinage_pelerinage-id`) ,
  CONSTRAINT `fk_Intervenant_Pelerinage_Intervenant1`
    FOREIGN KEY (`Intervenant_intervenant-id` )
    REFERENCES `spibook-1.0`.`Intervenant` (`intervenant-id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Intervenant_Pelerinage_Pelerinage1`
    FOREIGN KEY (`Pelerinage_pelerinage-id` )
    REFERENCES `spibook-1.0`.`Pelerinage` (`pelerinage-id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
